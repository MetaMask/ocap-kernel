...
- Pin vat root objects for the lifetime of their vat, releasing the pin on termination — including when a relaunch fails, which vat cleanup does not do ([#1010](https://github.com/MetaMask/ocap-kernel/pull/1010))
