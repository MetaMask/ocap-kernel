...
- Link the new [writing a netlayer](../../docs/writing-a-netlayer.md) guide from the package README, for which the loopback netlayer is the reference implementation ([#974](https://github.com/MetaMask/ocap-kernel/pull/974))
