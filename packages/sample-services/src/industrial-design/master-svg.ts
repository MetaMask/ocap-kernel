...
export const MASTER_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 820" font-family="Inkfree, 'Comic Sans MS', sans-serif" font-size="13">
  ...
  <!-- Remote body outline (slightly irregular, hand-drawn) -->
  ...
  <!-- =========================================== -->
  <!-- TOP: power (top-left) + mute (top-right)    -->
  <!--   isolated from volume so they can't be     -->
  <!--   bumped during volume adjustment           -->
  <!-- =========================================== -->
  ...
  <!-- OLED display, below the top corner buttons -->
  ...
  <!-- =========================================== -->
  <!-- MIDDLE: volume rocker (left) · voice center  -->
  <!--          · channel rocker (right)            -->
  <!-- =========================================== -->

  <!-- Volume rocker (left side, vertical, separated from mute) -->
  ...
  <!-- Channel rocker (right side, vertical) -->
  ...
  <!-- THE VOICE BUTTON — centerpiece, between vol and channel -->
  ...
  <!--   skip-back-30s · play/pause · fast-forward -->
  <!-- =========================================== -->
  <!-- Skip back 30s -->
  ...
  <!-- Microphone port indicator on top edge -->
  <circle class="sk sk-thin ir-fill" cx="442" cy="94" r="2.5" />

  <!-- IR transmitter window at bottom -->
  ...
  <!-- Voice button — annotation lives on right side, between mute and channel-rocker labels -->
  ...
  <!-- Channel rocker — leader runs below the voice annotation block -->
