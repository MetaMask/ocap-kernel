 ...
 *     (back arrowhead on the upper-left, fwd on the upper-right).
...
export const MASTER_SVG_REV2 = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 820" font-family="Inkfree, 'Comic Sans MS', sans-serif" font-size="13">
  ...
  <circle class="voice-ring" cx="350" cy="320" r="50" />
  <circle class="sk sk-med voice" cx="350" cy="320" r="42" />
  <circle class="sk sk-thin" cx="350" cy="320" r="36" opacity="0.5" />
  <g transform="translate(350 311)">
  ...
  <text x="350" y="388" text-anchor="middle" font-size="11" fill="#333">press · hold · speak</text>

  <rect class="sk sk-med btn-fill" x="225" y="405" width="36" height="120" rx="16" />
  <path class="sk sk-thin" d="M 235 433 L 243 421 L 251 433" stroke-linecap="round" />
  <path class="sk sk-thin" d="M 235 501 L 243 513 L 251 501" stroke-linecap="round" />
  <line class="sk sk-thin" x1="233" y1="465" x2="253" y2="465" opacity="0.4" />
  <text x="243" y="542" text-anchor="middle" font-size="10" fill="#444">vol</text>

  <g transform="translate(433 465)">
  ...
  <text x="433" y="542" text-anchor="middle" font-size="10" fill="#444">d-pad</text>
  ...
  <text x="56" y="126" class="label" fill="#666" font-size="11">38 kHz · {{irProtocols}}</text>
  ...
  <path class="leader" d="M 225 465 Q 160 465 110 458" />
  ...
  <path class="leader" d="M 400 320 Q 470 296 510 286" />
  ...
  <path class="leader" d="M 475 465 Q 540 458 568 452" />
