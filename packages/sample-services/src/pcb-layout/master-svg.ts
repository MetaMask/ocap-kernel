...
export const MASTER_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 880" font-family="Arial, sans-serif" font-size="8">
  ...
  <g transform="translate(130 40)">
    ...
    <g transform="translate(40 706)">
      <rect class="copper-fill" width="20" height="32" />
      <text x="10" y="48" text-anchor="middle" class="silk" font-size="7">BT1+</text>
    </g>
    ...
    <g class="copper" stroke-width="1.6">
      ...
      <path d="M 130 250 L 80 250 L 80 510" stroke-width="1.2" />
      <path d="M 130 268 L 70 268 L 70 562" stroke-width="1.2" />
      ...
      <path d="M 60 660 L 50 660 L 50 720" />
      <path d="M 130 670 L 130 712" />
      <path d="M 220 660 L 240 660 L 240 678 L 290 678 L 290 706" />
    </g>
  </g>
