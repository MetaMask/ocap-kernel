...
- feat: Make create-package ignore git-ignored files ([#648](https://github.com/MetaMask/ocap-kernel/pull/648))
...
- refactor: Convert package template to an actual package ([#631](https://github.com/MetaMask/ocap-kernel/pull/631))
