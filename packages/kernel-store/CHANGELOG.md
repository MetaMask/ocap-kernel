...
- feat(kernel-store): support absolute database paths ([#821](https://github.com/MetaMask/ocap-kernel/pull/821))
...
- chore: bump better-sqlite3 and revert rebuild script ([#702](https://github.com/MetaMask/ocap-kernel/pull/702))
