...
2. Run the prose pass over the diff: Skill tool with skill="prose-pass". Apply
   its cuts before staging anything. **Do not skip this**, however small the diff.

3. If you are on the `main` branch, create a new feature branch using `git branch` and switch to it.
